...
const options = {
  ...
  '5': {
    ...
    message: () => `First, make sure whatever "bug" you are experiencing isn't an intended change posted in the last few posts of <#599044275291947016>. That channel contains all of our update notes. Second, you can visit Trello and see existing and fixed bugs https://trello.com/b/rjE7PbGZ/dank-memer\n\nIf it is not, please go back to the help-desk channel and select the last option to speak with a support staff member.`,
  },
  '6': {
